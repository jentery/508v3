...
public class numberGame : MonoBehaviour {
	...
	void Start () {
		...
		print("===================================================="); // divider for start of next game; see the use of Start () below
	...
	void NextGuess () { // refactor with this function to avoid repetition of lines in the Update function 
